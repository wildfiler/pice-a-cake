...
Feature: Editing existing recipe
  ...
  Scenario: Delete component from recipe
    When delete component from recipe
    And click "Save Recipe"
    Then I expect to be on existing recipe page
    And I expect not to see that component

  Scenario: Delete step from recipe
    When delete step from recipe
    And click "Save Recipe"
    Then I expect to be on existing recipe page
    And I expect not to see that step
